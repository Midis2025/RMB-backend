...
export interface ApiContactFormContactForm extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    enquiryType: Schema.Attribute.Enumeration<
      ['buying_property', 'selling_property', 'general_enquiry', 'renting']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    carSpaces: Schema.Attribute.Integer;
    ...
    formattedPrice: Schema.Attribute.String;
    ...
    propertyType: Schema.Attribute.Enumeration<
      ['house', 'apartment', 'land', 'rural']
    >;
    publishedAt: Schema.Attribute.DateTime;
    publishOrder: Schema.Attribute.Integer;
    slug: Schema.Attribute.UID<'title'>;
    state: Schema.Attribute.String;
...
export interface ApiSoldPropertySoldProperty
  extends Struct.CollectionTypeSchema {
  collectionName: 'sold_properties';
  info: {
    displayName: 'sold-property';
    pluralName: 'sold-properties';
    singularName: 'sold-property';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::sold-property.sold-property'
    > &
      Schema.Attribute.Private;
    price: Schema.Attribute.BigInteger;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'>;
    soldDate: Schema.Attribute.Date;
    state: Schema.Attribute.String;
    suburb: Schema.Attribute.String;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
